...
function botRespond(){
  if(stage === 0){
    ...
    createMsg('亲，为您推荐以下产品：<br><b>「X-Lux 多功能智能台灯」</b><br>- 支持多段亮度与色温调节<br>- 搭载无线充电、时间显示与蓝牙音箱功能<br>- 外观简洁百搭，适合卧室、书桌、化妆台等多种空间<br>- 满足办公、阅读、放松等多种场景下的使用需求'+
        '<br><img src="./result2.jpg"' +
        'style="max-width:200px;border-radius:8px;margin-top:8px;">','bot');

    setTimeout(()=>{
      createMsg('🎉 感谢您的反馈，本轮对话已结束，您的服务代码是<b>VC100</b>，请返回问卷继续作答。','bot');
    },1000);
  }
  stage++;
}
